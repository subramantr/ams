...
describe "scheme_approvers/edit" do
  before(:each) do
  ...
  it "renders the edit scheme_approver form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", scheme_approver_path(@scheme_approver), "post" do
